#
#  Be sure to run `pod spec lint HKKitConfig.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.description  = <<-DESC
    ...
    这是一个基础封装的UIKit, 和暗黑颜色封装，字体宽高大小适配等 version：1.0.0
                   DESC
  ...
  spec.author             = { "张寿海" => "zhangshouhaivip@sina.cn" }
  # Or just: spec.author    = "张寿海"
  # spec.authors            = { "张寿海" => "zhangshouhaivip@sina.cn" }
  # spec.social_media_url   = "https://twitter.com/张寿海"
  ...
  spec.source       = { :git => "https://github.com/zhangshouhai/HKKitConfig.git", :tag => "v#{spec.version}" }
...
spec.source_files = "HKBaseConfig.h", "HKKitConfig/HKFixFloat/*.{h,m}","HKKitConfig/HKColor/*.{h,m}","HKKitConfig/HKFontFloat/*.{h,m}","HKKitConfig/HKScrollView/*.{h,m}","HKKitConfig/HKTabelViewCell/*.{h,m}","HKKitConfig/HKUIButton/*.{h,m}","HKKitConfig/HKUILabel/*.{h,m}","HKKitConfig/HKUItextField/*.{h,m}","HKKitConfig/HKView/*.{h,m}","HKKitConfig/*"
 ...
 #spec.subspec 'HKKitConfig' do |ss|
   
 #  ss.source_files = 'HKKitConfig/**.{h,m}'
